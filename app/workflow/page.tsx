...
export default function WorkflowPage(){
 ...
 const safety:SafetyReport={score:92,checks:[{id:"hollow",label:"是否存在空洞描述",status:"passed"},{id:"repeat",label:"是否重复内容",status:"passed"},{id:"marketing",label:"是否过度营销",status:"review"},{id:"platform",label:"是否符合平台规范",status:"passed"}]};
